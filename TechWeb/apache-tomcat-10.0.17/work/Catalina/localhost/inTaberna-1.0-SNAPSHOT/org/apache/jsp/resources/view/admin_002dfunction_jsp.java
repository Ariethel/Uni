 ...
 * Generated at: 2022-07-16 08:48:58 UTC
...
public final class admin_002dfunction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("      <h3 class=\"logo\"><a class=\"logo\" href=\"admin-home.jsp\">In Taberna</a></h3>\n");
      out.write("    </div>\n");
      out.write("\n");
      ...
      out.write("        <li class=\"buttons\"><a class=\"buttons\" href=\"../../chart\">ð</a></li>\n");
      ...
      out.write("    xmlhttp.onreadystatechange=function() {\n");
      out.write("      if (this.readyState==4 && this.status==200) {\n");
      out.write("        const obj = JSON.parse(this.responseText);\n");
      out.write("        for (let i = 0; i < obj.length; i++){\n");
      out.write("          $(\"#userList ul\").append(\"<li>\"+ obj[i].name +\n");
      out.write("                  \"<form action=\\\"../../updateUser\\\">\"+\n");
      out.write("                    \"<input type=\\\"hidden\\\" name=\\\"id\\\" value=\\\"\"+obj[i].name+\"\\\">\" +\n");
      out.write("                    \"<input type=\\\"submit\\\" value=\\\"Modifica\\\">\"+\n");
      out.write("                  \"<input type=\\\"submit\\\" formaction=\\\"../../deleteUser\\\" value=\\\"Cancella\\\">\"\n");
      out.write("                  +\"</form>\" + \"</li>\");\n");
      out.write("        }\n");
      out.write("      }\n");
      out.write("    }\n");
      out.write("    xmlhttp.open(\"GET\",\"../../getUser\",true);\n");
      out.write("    xmlhttp.send();\n");
      out.write("  })\n");
      out.write("\n");
      out.write("  $(document).ready(function(){\n");
      ...
      out.write("        const obj = JSON.parse(this.responseText);\n");
      out.write("        for (let i = 0; i < obj.length; i++){\n");
      out.write("          $(\"#albumList ul\").append(\"<li>\"+ obj[i].name +\n");
      out.write("          \"<form action=\\\"../../updateAlbum\\\">\"+\n");
      out.write("          \"<input type=\\\"hidden\\\" name=\\\"id\\\" value=\\\"\"+obj[i].name+\"\\\">\" +\n");
      out.write("          \"<input type=\\\"submit\\\" value=\\\"Modifica\\\">\" +\n");
      out.write("          \"<input type=\\\"submit\\\" formaction=\\\"../../deleteAlbum\\\" value=\\\"Cancella\\\">\"\n");
      out.write("          +\"</form>\" + \"</li>\");\n");
      out.write("        }\n");
      out.write("      }\n");
      out.write("    }\n");
      out.write("    xmlhttp.open(\"GET\",\"../../getAlbum\",true);\n");
      out.write("    xmlhttp.send();\n");
      out.write("  })\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("        const obj = JSON.parse(this.responseText);\n");
      out.write("        for (let i = 0; i < obj.length; i++){\n");
      out.write("          $(\"#albumListSong ul\").append(\"<li>\"+ obj[i].name +\n");
      out.write("                  \"<form action=\\\"showSong.jsp\\\">\"+\n");
      out.write("                  \"<input type=\\\"hidden\\\" name=\\\"id\\\" value=\\\"\"+obj[i].name+\"\\\">\" +\n");
      out.write("                  \"<input type=\\\"submit\\\" value=\\\"Visualizza\\\">\"\n");
      out.write("                  +\"</form>\" + \"</li>\");\n");
      out.write("        }\n");
      out.write("      }\n");
      out.write("    }\n");
      ...
      out.write("  <div>\n");
      out.write("    <h3>Gestisci utenti</h3>\n");
      ...
      out.write("\n");
      out.write("  <div>\n");
      out.write("    <h3>Gestisci Album</h3>\n");
      out.write("    <div id=\"albumList\">\n");
      out.write("      <ul>\n");
      out.write("\n");
      out.write("      </ul>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <h3>Aggiungi Album</h3>\n");
      out.write("    <div id=\"addAlbum\">\n");
      out.write("      <form action=\"../../addalbumservlet\" method=\"post\" enctype=\"multipart/form-data\">\n");
      out.write("        <input type=\"text\" name=\"titolo\" placeholder=\"Titolo\">\n");
      out.write("        <input type=\"number\" name=\"prezzo\" step=\"any\" min=â0â³ placeholder=\"Prezzo\">\n");
      out.write("        <input type=\"file\" name=\"file\" placeholder=\"Copertina\">\n");
      out.write("        <label for=\"homepage\">homepage</label>\n");
      out.write("        <input type=\"checkbox\" id=\"homepage\" name=\"homepage\">\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("    <h3>Gestisci canzoni</h3>\n");
      out.write("    <h5>Visualizza Canzoni</h5>\n");
      out.write("    <div id=\"albumListSong\">\n");
      out.write("      <ul>\n");
      out.write("\n");
      out.write("      </ul>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <h5>Aggiungi canzone</h5>\n");
      out.write("    <form action=\"../../addSong\">\n");
      out.write("      <input type=\"text\" name=\"c_title\" placeholder=\"Nome Canzone\">\n");
      out.write("      <input type=\"text\" name=\"a_title\" placeholder=\"Nome Album\">\n");
