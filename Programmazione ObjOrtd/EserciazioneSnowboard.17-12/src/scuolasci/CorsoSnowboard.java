...
public class CorsoSnowboard implements Corso{
	...
	public  CorsoSnowboard(int id_p, int numeroPartecipanti, int durataCorsoGiorni, GregorianCalendar dataInizio) {
	...
	public String toString() {
		return "CorsoSnowboard [id_p=" + id_p + ", numeroPartecipanti=" + numeroPartecipanti + ", durataCorsoGiorni="
				+ durataCorsoGiorni + "]";
	}
